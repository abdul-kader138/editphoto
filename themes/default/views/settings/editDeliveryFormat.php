...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('Edit_Delivery_Format'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        echo form_open("system_settings/editDeliveryFormat/".$sd_detail->id, $attrib); ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_delivery_format', lang('Edit_Delivery_Format'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
