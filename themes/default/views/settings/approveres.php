...
<script>
    $(document).ready(function () {
        $('#CategoryTable').dataTable({
            ...
            'sAjaxSource': '<?= site_url('system_settings/getApprover') ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa fa-user"></i><?= lang('Approveres'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo site_url('system_settings/add_approver'); ?>" data-toggle="modal" data-target="#myModal">
